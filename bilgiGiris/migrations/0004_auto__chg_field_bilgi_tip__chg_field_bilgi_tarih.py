...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bilgi.tip'
        db.alter_column('bilgiGiris_bilgi', 'tip_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['bilgiGiris.Tip']))

        # Changing field 'Bilgi.tarih'
        db.alter_column('bilgiGiris_bilgi', 'tarih', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Changing field 'Bilgi.tip'
        db.alter_column('bilgiGiris_bilgi', 'tip_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bilgiGiris.Tip'], null=True))

        # Changing field 'Bilgi.tarih'
        db.alter_column('bilgiGiris_bilgi', 'tarih', self.gf('django.db.models.fields.DateTimeField')())
