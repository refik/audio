...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bilgi.tip'
        db.add_column('bilgiGiris_bilgi', 'tip', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bilgiGiris.Tip'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Bilgi.tip'
        db.delete_column('bilgiGiris_bilgi', 'tip_id')
    ...
    models = {
        ...
        'bilgiGiris.bilgi': {
            ...
            'tarih': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 7, 0, 13, 12, 894757)'}),
