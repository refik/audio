...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Ilce'
        db.create_table('bilgiGiris_ilce', (
        ...
        db.send_create_signal('bilgiGiris', ['Ilce'])

        # Adding field 'Bilgi.ilce'
        db.add_column('bilgiGiris_bilgi', 'ilce', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bilgiGiris.Ilce']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Ilce'
        db.delete_table('bilgiGiris_ilce')

        # Deleting field 'Bilgi.ilce'
        db.delete_column('bilgiGiris_bilgi', 'ilce_id')
    ...
    models = {
        ...
        'bilgiGiris.bilgi': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ilce': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bilgiGiris.Ilce']"}),
