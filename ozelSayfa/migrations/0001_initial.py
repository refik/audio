...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Sayfa'
        db.create_table('ozelSayfa_sayfa', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('isim', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('ozelSayfa', ['Sayfa'])

        # Adding model 'SayfaLink'
        db.create_table('ozelSayfa_sayfalink', (
            ('link_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ortakVeri.Link'], unique=True, primary_key=True)),
            ('yazi', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('gorunum', self.gf('filebrowser.fields.FileBrowseField')(max_length=200)),
            ('sayfa_ait', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ozelSayfa.Sayfa'])),
        ))
        db.send_create_signal('ozelSayfa', ['SayfaLink'])

        # Adding model 'SayfaMedya'
        db.create_table('ozelSayfa_sayfamedya', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('isim', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('dosya', self.gf('filebrowser.fields.FileBrowseField')(max_length=200)),
            ('sayfaait', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ozelSayfa.Sayfa'])),
            ('yazi', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal('ozelSayfa', ['SayfaMedya'])


    def backwards(self, orm):
        
        # Deleting model 'Sayfa'
        db.delete_table('ozelSayfa_sayfa')

        # Deleting model 'SayfaLink'
        db.delete_table('ozelSayfa_sayfalink')

        # Deleting model 'SayfaMedya'
        db.delete_table('ozelSayfa_sayfamedya')
