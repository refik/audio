...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'TeklifYapilan'
        db.delete_table('teklif_teklifyapilan')

        # Adding model 'Yapildi'
        db.create_table('teklif_yapildi', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('kullanici', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('teklif', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teklif.Teklif'])),
        ...
        db.send_create_signal('teklif', ['Yapildi'])


    def backwards(self, orm):
        
        # Adding model 'TeklifYapilan'
        db.create_table('teklif_teklifyapilan', (
            ('dosya', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('durum', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teklif.Durum'], null=True, blank=True)),
            ('mesaj', self.gf('django.db.models.fields.TextField')()),
            ('kullanici', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        db.send_create_signal('teklif', ['TeklifYapilan'])

        # Deleting model 'Yapildi'
        db.delete_table('teklif_yapildi')
