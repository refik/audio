...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeklifYorum.delege'
        db.add_column('teklif_teklifyorum', 'delege', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TeklifYorum.delege'
        db.delete_column('teklif_teklifyorum', 'delege_id')
