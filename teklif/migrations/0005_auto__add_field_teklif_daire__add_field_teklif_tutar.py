...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Teklif.daire'
        db.add_column('teklif_teklif', 'daire', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Teklif.tutar'
        db.add_column('teklif_teklif', 'tutar', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Teklif.daire'
        db.delete_column('teklif_teklif', 'daire')

        # Deleting field 'Teklif.tutar'
        db.delete_column('teklif_teklif', 'tutar')
