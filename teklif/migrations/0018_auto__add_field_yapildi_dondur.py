...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Yapildi.dondur'
        db.add_column('teklif_yapildi', 'dondur', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Yapildi.dondur'
        db.delete_column('teklif_yapildi', 'dondur')
