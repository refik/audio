...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field sebep on 'TeklifYorum'
        db.create_table('teklif_teklifyorum_sebep', (
        ...
        db.create_unique('teklif_teklifyorum_sebep', ['teklifyorum_id', 'sebep_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field sebep on 'TeklifYorum'
        db.delete_table('teklif_teklifyorum_sebep')
