...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OtomatikTeklif.teklif'
        db.alter_column('teklif_otomatikteklif', 'teklif_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['teklif.Teklif'], unique=True))

        # Adding unique constraint on 'OtomatikTeklif', fields ['teklif']
        db.create_unique('teklif_otomatikteklif', ['teklif_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'OtomatikTeklif', fields ['teklif']
        db.delete_unique('teklif_otomatikteklif', ['teklif_id'])

        # Changing field 'OtomatikTeklif.teklif'
        db.alter_column('teklif_otomatikteklif', 'teklif_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teklif.Teklif']))
    ...
    models = {
        ...
        'teklif.otomatikteklif': {
            'Meta': {'object_name': 'OtomatikTeklif'},
            'durum': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'musteri': ('django.db.models.fields.TextField', [], {}),
            'tarih': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'teklif': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['teklif.Teklif']", 'unique': 'True'})
        },
        'teklif.rakip': {
