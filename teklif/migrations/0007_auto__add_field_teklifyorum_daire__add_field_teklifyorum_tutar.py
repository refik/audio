...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeklifYorum.daire'
        db.add_column('teklif_teklifyorum', 'daire', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'TeklifYorum.tutar'
        db.add_column('teklif_teklifyorum', 'tutar', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TeklifYorum.daire'
        db.delete_column('teklif_teklifyorum', 'daire')

        # Deleting field 'TeklifYorum.tutar'
        db.delete_column('teklif_teklifyorum', 'tutar')
