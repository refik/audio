...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Teklif.son_eylem'
        db.add_column('teklif_teklif', 'son_eylem', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Teklif.son_eylem'
        db.delete_column('teklif_teklif', 'son_eylem')
