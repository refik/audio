...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Yapildi.iscilik'
        db.add_column('teklif_yapildi', 'iscilik', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Yapildi.baglanti'
        db.add_column('teklif_yapildi', 'baglanti', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Yapildi.iscilik'
        db.delete_column('teklif_yapildi', 'iscilik')

        # Deleting field 'Yapildi.baglanti'
        db.delete_column('teklif_yapildi', 'baglanti')
