...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeklifYorum.dosya'
        db.add_column('teklif_teklifyorum', 'dosya', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TeklifYorum.dosya'
        db.delete_column('teklif_teklifyorum', 'dosya')
