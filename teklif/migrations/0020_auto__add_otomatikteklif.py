...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OtomatikTeklif'
        db.create_table('teklif_otomatikteklif', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tarih', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('musteri', self.gf('django.db.models.fields.TextField')()),
            ('durum', self.gf('django.db.models.fields.TextField')()),
            ('teklif', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teklif.Teklif'])),
        ))
        db.send_create_signal('teklif', ['OtomatikTeklif'])


    def backwards(self, orm):
        
        # Deleting model 'OtomatikTeklif'
        db.delete_table('teklif_otomatikteklif')
