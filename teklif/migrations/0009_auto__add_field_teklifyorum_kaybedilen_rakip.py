...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeklifYorum.kaybedilen_rakip'
        db.add_column('teklif_teklifyorum', 'kaybedilen_rakip', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teklif.Rakip'], null=True, blank=True), keep_default=False)

        # Adding M2M table for field kaybetme_sebepleri on 'TeklifYorum'
        db.create_table('teklif_teklifyorum_kaybetme_sebepleri', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('teklifyorum', models.ForeignKey(orm['teklif.teklifyorum'], null=False)),
            ('sebep', models.ForeignKey(orm['teklif.sebep'], null=False))
        ))
        db.create_unique('teklif_teklifyorum_kaybetme_sebepleri', ['teklifyorum_id', 'sebep_id'])


    def backwards(self, orm):
        
        # Deleting field 'TeklifYorum.kaybedilen_rakip'
        db.delete_column('teklif_teklifyorum', 'kaybedilen_rakip_id')

        # Removing M2M table for field kaybetme_sebepleri on 'TeklifYorum'
        db.delete_table('teklif_teklifyorum_kaybetme_sebepleri')
    ...
    models = {
        ...
        'teklif.teklifyorum': {
            ...
            'daire': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'delege': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
