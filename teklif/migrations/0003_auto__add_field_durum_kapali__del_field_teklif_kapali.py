...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Durum.kapali'
        db.add_column('teklif_durum', 'kapali', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Teklif.kapali'
        db.delete_column('teklif_teklif', 'kapali')


    def backwards(self, orm):
        
        # Deleting field 'Durum.kapali'
        db.delete_column('teklif_durum', 'kapali')

        # Adding field 'Teklif.kapali'
        db.add_column('teklif_teklif', 'kapali', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
